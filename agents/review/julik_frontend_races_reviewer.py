...
class JulikFrontendRacesReviewer(dspy.Signature):
    ...
    code_diff = dspy.InputField(
        desc="The code changes to review, focusing on JavaScript, Stimulus, and frontend logic."
    )
    race_condition_analysis = dspy.OutputField(
        desc="A witty, direct, and thorough analysis of potential race conditions and UI timing issues."
    )
