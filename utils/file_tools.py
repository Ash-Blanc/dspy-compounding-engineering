...
def read_file_range(file_path: str, start_line: int = 1, end_line: int = -1, base_dir: str = ".") -> str:
    """
...
def edit_file_lines(file_path: str, edits: List[Dict[str, Union[int, str]]], backup: bool = True, base_dir: str = ".") -> str:
    """
